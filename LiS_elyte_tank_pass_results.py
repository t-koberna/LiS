...
atol = 1e-10    # max 1e-8    
custom_atol = np.full(np.size(SV_0), 0.0)       
custom_atol[SV_idx.ptr['mass_S8']] = 1e-4
custom_atol[SV_idx.ptr['mass_Li2S']] = atol
custom_atol[SV_idx.ptr['C_k_elyte'][0]] = 1e-2
custom_atol[SV_idx.ptr['C_k_elyte'][1]] = 1e-4
custom_atol[SV_idx.ptr['C_k_elyte'][2:9]] = atol
custom_atol[SV_idx.ptr['C_k_elyte'][9:]] = 1e-8

first_step = 1e-10                                                 # Size of the initial time step
# set up and run the solver
time_start = 0                                                      # Initial time [s]
time_end = 8e-11    
time_end_2 = 2e-10                                        # Final time [s]
...
options =  {'userdata':(SV_idx, tank, solids, params, elyte_volume,max_rate, min_rate),
            'rtol':rtol,'atol':custom_atol, 'first_step':first_step, 'method': method, 'constraints_idx': const_idx,'constraints_type': const_type}
...
custom_atol[SV_idx.ptr['C_k_elyte'][9:]] = custom_atol[SV_idx.ptr['C_k_elyte'][9]]*1e2
#rtol = 1e-8                                                         # Relative tolerance
#atol = 1e-12
options_2 =  {'userdata':(SV_idx, tank, solids, params, elyte_volume,max_rate_2, min_rate_2),
            'rtol':rtol_2,'atol':custom_atol, 'first_step':first_step, 'method': method, 'constraints_idx': const_idx,'constraints_type': const_type}
...
atol_2 = 1e-10
time_end_2 = 2e-8                                        # Final time [s]

custom_atol[SV_idx.ptr['C_k_elyte'][2:9]] = custom_atol[SV_idx.ptr['C_k_elyte'][9]]*1e4
