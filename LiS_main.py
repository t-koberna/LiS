...
n_bucket_S8 = 40 # number of buckets for S8 [-]
n_bucket_Li2S = 40 # number of buckets for Li2S [-]

t_bucket_S8 = 1e-8 # the radius range (aka thickness) of each bucket for S8 [m]
t_bucket_Li2S = 1e-8 # the radius range (aka thickness) of each bucket for Li2S [m]
